...
/* --> heartBeatTask */
extern xdc_Void heartBeatTask(xdc_UArg,xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6474];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/HAKAN/workspace_v10/p14_HakanC/Debug/configPkg/package/cfg/httpget_pem4f");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[3] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)heartBeatTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)0),  /* env */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x194a;
